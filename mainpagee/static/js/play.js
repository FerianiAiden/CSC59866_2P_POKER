...
async function bet() {
  ...
  document.getElementById("rotate").style.animationPlayState = "running";
  document.getElementById("rotate2").style.animationPlayState = "running";
  document.getElementById("rotate3").style.animationPlayState = "running";
  document.getElementById("rotate4").style.animationPlayState = "running";
...
function pickaRandomCards(id,choice){
  ...
  if(chose == 0){
    ...
    //document.querySelector('#coin').setAttribute('class','.animate-tails');
...
function CasinoPlaceBigBlind(){
  ...
  [].forEach.call(document.querySelectorAll('.front'), function (el) {
    el.style.visibility = 'hidden';
  });
  [].forEach.call(document.querySelectorAll('.game'), function (el) {
...
function restart_game(){
  ...
  //deck = deck1;
    ...
    hide_all_button();
    // if (last_bet_total > 0){
    //   document.getElementById("text1").innerText = "You won " + last_bet_total +" milliethers";
    // }
    // else{
    //   document.getElementById("text1").innerText = "You lost " + last_bet_total +" milliethers";
    // }
    ...
    document.getElementById("rotate").style.animationPlayState = "paused";
    document.getElementById("rotate2").style.animationPlayState = "paused";
    document.getElementById("rotate3").style.animationPlayState = "paused";
    document.getElementById("rotate4").style.animationPlayState = "paused";
